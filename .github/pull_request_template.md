...
- [ ] I searched [open issues](https://github.com/<you>/lodestar/issues) and [open PRs](https://github.com/<you>/lodestar/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Lodestar's existing visual language. Specifically:
