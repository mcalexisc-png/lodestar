...
Registration, authorization-code + PKCE, token refresh) to Lodestar's web
...
# on Lodestar. APP_PORT is intentionally not used: it is only the Docker host
