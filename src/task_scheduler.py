...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Lodestar-Origin"] = "lodestar-ui"
            msg["X-Lodestar-Kind"] = "task"
            msg["X-Lodestar-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Lodestar-Origin": "lodestar-ui",
                "X-Lodestar-Kind": "task",
                "X-Lodestar-Ref": str(task.id),
            },
        }
        if recipient:
